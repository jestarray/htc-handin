...
(define server:port "jestlearn.com:7979")
...
(define web-address "https://jestlearn.com/how_to_code")
...
(define password-keep-minutes 9999) ; client remembers entered password 5 mins
